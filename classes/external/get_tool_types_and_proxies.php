...
namespace mod_orcalti\external;
...
class get_tool_types_and_proxies extends \external_api {
    ...
    public static function execute($toolproxyid, $orphanedonly, $limit, $offset): array {
        ...
        list($proxies, $types) = orcalti_get_orcalti_types_and_proxies($limit, $offset, $orphanedonly, $toolproxyid);
    ...
    public static function execute_returns(): \external_single_structure {
        return new \external_single_structure([
            'types' => \mod_orcalti_external::get_tool_types_returns(),
            'proxies' => \mod_orcalti_external::get_tool_proxies_returns(),
