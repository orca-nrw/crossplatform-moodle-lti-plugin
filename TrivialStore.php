...
class TrivialOAuthDataStore extends OAuthDataStore {
     ...
     * @param string $consumerkey     Consumer key
     *
     * @return moodle\mod\orcalti\OAuthConsumer  OAuthConsumer object
     */
     ...
     *
     * @param moodle\mod\orcalti\OAuthConsumer $consumer     Consumer
     * @param string $tokentype    Type of token
     * @param string $token        Token ID
     *
     * @return moodle\mod\orcalti\OAuthToken OAuthToken object
     */
