...
There were no tools shared whith you, or there are no tools available.';

$string["modal_fullscreen_description"] = "Choose an ORCA-Activity to embed.";
$string["modal_close"] = "Close ORCA-Tool";
$string["orca_logo_alt"] = "Logo ORCA.nrw";
$string["website_url_orca"] = "https://www.orca.nrw/";
$string["orca_link_title"] = "To ORCA.nrw";
$string["categories"] = "Categories";
$string["contact"] = "Contact us";
$string["email_address_orca"] = "support{'@'}orca.nrw";
$string["send_support_request"] = "E-mail a support request to ORCA.nrw";
$string["input_search_id"] = "incremental_search_courses";
$string["input_search_placeholder"] = "Search for content";
$string["searching_in_all_categories"] = "You are searching in all categories";
$string["searching_in_category"] = "You are searching in";
$string["search_no_content_found"] = "No results for";
$string["no_search_no_content_found"] = "No content found.";
$string["expand_description"] = "more";
$string["collapse_description"] = "close";
...
$string['orcalti_password'] = 'ORCA-LTI password';
