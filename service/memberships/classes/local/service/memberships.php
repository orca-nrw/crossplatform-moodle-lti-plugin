...
namespace orcaltiservice_memberships\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class memberships extends \mod_orcalti\local\orcaltiservice\service_base {
    ...
    public function get_resources() {
        ...
        if (empty($this->resources)) {
            ...
            $this->resources[] = new \orcaltiservice_memberships\local\resources\contextmemberships($this);
            $this->resources[] = new \orcaltiservice_memberships\local\resources\linkmemberships($this);
        }
