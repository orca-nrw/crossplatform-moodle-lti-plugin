...
namespace orcaltiservice_memberships\local\resources;

use mod_orcalti\local\orcaltiservice\resource_base;
use orcaltiservice_memberships\local\service\memberships;
...
class contextmemberships extends resource_base {
     ...
     * Class constructor.
     *
     * @param \orcaltiservice_memberships\local\service\memberships $service Service instance
     */
