...
/**
 * xmldb_orcaltiservice_gradebookservices_upgrade is the function that upgrades
    ...
    if ($oldversion < 2020042402) {
        ...
        $DB->execute("INSERT INTO {orcaltisrv_gradebookservices}
         ...
         SELECT gi.id, courseid, lti.typeid, lti.id, gi.idnumber, t.baseurl, t.toolproxyid
           FROM {grade_items} gi
           JOIN {orcalti} lti ON lti.id=gi.iteminstance AND gi.itemtype='mod' AND gi.itemmodule='orcalti'
           JOIN {orcalti_types} t ON t.id = lti.typeid
