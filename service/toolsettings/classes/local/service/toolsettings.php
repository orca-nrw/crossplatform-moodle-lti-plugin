...
namespace orcaltiservice_toolsettings\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class toolsettings extends \mod_orcalti\local\orcaltiservice\service_base {
    ...
    public function get_resources() {
        ...
        if (empty($this->resources)) {
            ...
            $this->resources[] = new \orcaltiservice_toolsettings\local\resources\systemsettings($this);
            $this->resources[] = new \orcaltiservice_toolsettings\local\resources\contextsettings($this);
            $this->resources[] = new \orcaltiservice_toolsettings\local\resources\linksettings($this);
        }
