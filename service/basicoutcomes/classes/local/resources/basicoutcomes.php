...
namespace orcaltiservice_basicoutcomes\local\resources;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class basicoutcomes extends \mod_orcalti\local\orcaltiservice\resource_base {
    ...
    public function get_endpoint() {
        ...
        $url = new \moodle_url('/mod/orcalti/service.php');
