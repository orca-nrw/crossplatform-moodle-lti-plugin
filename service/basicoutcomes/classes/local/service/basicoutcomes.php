...
namespace orcaltiservice_basicoutcomes\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class basicoutcomes extends \mod_orcalti\local\orcaltiservice\service_base {
    ...
    public function get_resources() {
        ...
        if (empty($this->resources)) {
            ...
            $this->resources[] = new \orcaltiservice_basicoutcomes\local\resources\basicoutcomes($this);
        }
    ...
    public function get_permitted_scopes() {
        ...
        $scopes = array();
        if (!isset($this->get_typeconfig()['acceptgrades']) || ($this->get_typeconfig()['acceptgrades'] != ORCALTI_SETTING_NEVER)) {
