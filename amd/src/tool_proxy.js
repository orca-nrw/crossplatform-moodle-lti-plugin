...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return /** @alias module:mod_orcalti/tool_proxy */ {
        /**
        ...
        query: function(args) {
            var request = {
                methodname: 'mod_orcalti_get_tool_proxies',
                args: args || {}
            };
        ...
        'delete': function(id) {
            var request = {
                methodname: 'mod_orcalti_delete_tool_proxy',
                args: {
                    id: id
                }
            };
         ...
         *
         * See mod/orcalti/classes/external.php create_tool_proxy_parameters
         *
         * @method create
         * @public
        ...
        create: function(args) {
            var request = {
                methodname: 'mod_orcalti_create_tool_proxy',
                args: args
            };
