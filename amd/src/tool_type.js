...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return /** @alias module:mod_orcalti/tool_type */ {
        /**
         * Get a list of tool types from Moodle for the given
         * search args.
         *
         * See also:
         * mod/orcalti/classes/external.php get_tool_types_parameters()
         *
         * @method query
         * @public
        ...
        query: function(args) {
            var request = {
                methodname: 'mod_orcalti_get_tool_types',
                args: args || {}
            };
         ...
         *
         * See also:
         * mod/orcalti/classes/external.php create_tool_type_parameters()
         *
         * @method create
         * @public
        ...
        create: function(args) {
            var request = {
                methodname: 'mod_orcalti_create_tool_type',
                args: args
            };
         ...
         *
         * See also:
         * mod/orcalti/classes/external.php update_tool_type_parameters()
         *
         * @method update
         * @public
         * @param {Object} args Tool type properties
        ...
        update: function(args) {
            var request = {
                methodname: 'mod_orcalti_update_tool_type',
                args: args
            };
        ...
        'delete': function(id) {
            var request = {
                methodname: 'mod_orcalti_delete_tool_type',
                args: {
                    id: id
                }
            };
        ...
        isCartridge: function(url) {
            var request = {
                methodname: 'mod_orcalti_is_cartridge',
                args: {
                    url: url
                }
            };
