...
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'mod_orcalti/events',
     ...
     *
     * See mod_orcalti/tool_proxy_registration_form template.
     *
    ...
    var getRegistrationRequest = function(id) {
        var request = {
            methodname: 'mod_orcalti_get_tool_proxy_registration_request',
            args: {
                id: id
            }
        };
    ...
    var cancelRegistration = function() {
        ...
        promise.done(function() {
            ...
            finishExternalRegistration();
            stopLoadingCancel();
            str.get_string('failedtodeletetoolproxy', 'mod_orcalti').done(function(s) {
                var feedback = {
                    message: s,
                    error: true
                };
    ...
    var renderExternalRegistrationWindow = function(registrationRequest) {
        var promise = templates.render('mod_orcalti/tool_proxy_registration_form', registrationRequest);
    ...
    var promptForToolTypeCapabilitiesAgreement = function(typeData) {
        ...
        templates.render('mod_orcalti/tool_type_capabilities_agree', typeData).done(function(html, js) {
    ...
    var registerEventListeners = function() {
        ...
        // parameters.
        //
        // See AMD module mod_orcalti/external_registration_return.
