...
$functions = array(
    ...
    'mod_orcalti_get_tool_launch_data' => array(
        ...
        'type'          => 'read',
        'capabilities'  => 'mod/orcalti:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_orcalti_get_orcaltis_by_courses' => array(
        'classname'     => 'mod_orcalti_external',
        'methodname'    => 'get_orcaltis_by_courses',
    ...
    'mod_orcalti_view_orcalti' => array(
        'classname'     => 'mod_orcalti_external',
        'methodname'    => 'view_orcalti',
    ...
    'mod_orcalti_get_tool_proxies' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_create_tool_proxy' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_delete_tool_proxy' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_get_tool_proxy_registration_request' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_get_tool_types' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_update_tool_type' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_delete_tool_type' => array(
        'classname'     => 'mod_orcalti_external',
    ...
    'mod_orcalti_is_cartridge' => array(
        'classname'     => 'mod_orcalti_external',
