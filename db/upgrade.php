...
/**
 * This file keeps track of upgrades to the orcalti module
 *
 * @package mod_orcalti
 ...
 * the orcalti module database when is needed
 *
...
function xmldb_orcalti_upgrade($oldversion) {
    ...
    if ($oldversion < 2021052501) {
        ...
        // Changing type of field instructorcustomparameters on table orcalti to text.
        ...
        upgrade_mod_savepoint(true, 2021052501, 'orcalti');
    }

    if ($oldversion < 2022032900) {
        // This option 'Public key type' was added in MDL-66920, but no value was set for existing 1.3 tools.
        // Set a default of 'RSA Key' for those ORCALTI 1.3 tools without a value, representing the only key type they
        ...
        $sql = "SELECT t.id
             ...
             LEFT JOIN {lti_types_config} tc
                 ...
                 WHERE t.orcaltiversion = :orcaltiversion
                   AND tc.value IS NULL";
        $params = ['typename' => 'keytype', 'orcaltiversion' => '1.3.0'];
        ...
        // Lti savepoint reached.
        upgrade_mod_savepoint(true, 2022032900, 'orcalti');
    }
