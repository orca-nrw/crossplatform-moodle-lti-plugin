...
$isget = $response->get_request_method() === mod_orcalti\local\orcaltiservice\resource_base::HTTP_GET;
$isdelete = $response->get_request_method() === mod_orcalti\local\orcaltiservice\resource_base::HTTP_DELETE;
